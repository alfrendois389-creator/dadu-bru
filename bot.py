# bot.py — FULL CODE (TAMBAH USERNAME ADMIN)
# BOT DADU DUEL + NOTIF (SATU FILE)
...
BOT_NOTIF_TOKEN = "8607142852:AAEORX8WtSHE2yCN3PKwvZLV4xdW6npLd6o"
ADMIN_IDS = [8502398484]
ADMIN_USERNAME = "@dolasan"
...
bot_notif = Bot(token=BOT_NOTIF_TOKEN)
